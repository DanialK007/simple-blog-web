  ...
  return (
    ...
    >
      <Sidebar open={open} setOpen={setOpen} animate={true}>
        <SidebarBody className="justify-between gap-10 fixed left-0 top-0 z-50">
...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-1 lg:ps-10">
      <div className="p-2 md:p-10 rounded-tl-2xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 flex flex-col gap-2 flex-1 w-full">
        ...
        <div className="flex gap-2">
          <div className="h-full w-full rounded-lg bg-gray-100 dark:bg-neutral-800 p-8  ">
